...
class FrankaInterface:
    ...
    def __init__(
        ...
        self._gripper_pub_port = general_cfg.PC.GRIPPER_SUB_PORT
        self._gripper_sub_port = general_cfg.PC.GRIPPER_PUB_PORT
        ...
        self._gripper_subscriber.connect(f"tcp://{general_cfg.PC.IP}:{self._gripper_sub_port}")
